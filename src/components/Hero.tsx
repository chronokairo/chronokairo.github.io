...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 -left-40 w-[600px] h-[600px] bg-white/[0.02] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -right-40 w-[500px] h-[500px] bg-white/[0.02] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="w-[480px] h-[480px] opacity-[0.035]"
        />
      </div>
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-light leading-[1.08] tracking-[-0.02em] mb-8 text-white animate-fade-in-up">
            Tecnologia no<br />
            <em className="not-italic font-extralight text-white/55">tempo certo.</em>
          </h1>
